...
# "\Users\GMIT.DESKTOP-SLAHD3V\Ingenieria y Gestion Administrativa S.A.S\EQUIPO_GMIT - Documentos\Coordinadora de programación\RPA Officetrack\Excel_officeTrack\wm_task.xlsx"
archivo_origen = r'C:\Users\GMIT.DESKTOP-SLAHD3V\Ingenieria y Gestion Administrativa S.A.S\EQUIPO_GMIT - Documentos\Coordinadora de programación\RPA Officetrack\Excel_officeTrack\wm_task.xlsx'
archivo_destino_original = r'C:\Users\GMIT.DESKTOP-SLAHD3V\Ingenieria y Gestion Administrativa S.A.S\EQUIPO_GMIT - Documentos\Coordinadora de programación\RPA Officetrack\Excel_officeTrack\llenadoDatos.xlsx'
ruta_destino_nueva = r'C:\Users\GMIT.DESKTOP-SLAHD3V\Ingenieria y Gestion Administrativa S.A.S\EQUIPO_GMIT - Documentos\Coordinadora de programación\RPA Officetrack\Excel_officeTrack\Cambios\nueva_copia.xlsx'
...
for fila in hoja_destino_importe.iter_rows(min_row=2, max_row=hoja_destino_importe.max_row, min_col=8, max_col=9):  # Columnas H e I
    ...
    if fecha_inicio and fecha_fin:
        ...
        # Calcular la diferencia en horas entre fecha de inicio y fecha de fin
        diferencia_horas = (fecha_fin - fecha_inicio).total_seconds() / 3600
        # Si las fechas son iguales, establecer la diferencia en 24 horas
        ...
        celda_n.value = diferencia_horas
...
#"C:\Users\JuanVC\Ingenieria y Gestion Administrativa S.A.S\EQUIPO_GMIT - Documentos\Coordinadora de programación\RPA Officetrack\Excel_officeTrack\Cambios\nueva_copia.xlsx"
archivo_original = r'C:\Users\GMIT.DESKTOP-SLAHD3V\Ingenieria y Gestion Administrativa S.A.S\EQUIPO_GMIT - Documentos\Coordinadora de programación\RPA Officetrack\Excel_officeTrack\Cambios\nueva_copia.xlsx'

# Ruta y nombre de la carpeta para el nuevo archivo de Excel
carpeta_nueva = r'C:\Users\GMIT.DESKTOP-SLAHD3V\Ingenieria y Gestion Administrativa S.A.S\EQUIPO_GMIT - Documentos\Coordinadora de programación\RPA Officetrack\Excel_officeTrack\Cambios'
